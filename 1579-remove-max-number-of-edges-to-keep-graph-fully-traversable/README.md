<h2><a href="https://leetcode.com/problems/remove-max-number-of-edges-to-keep-graph-fully-traversable/?envType=problem-list-v2&envId=wrz5y2es">1579. Remove Max Number of Edges to Keep Graph Fully Traversable</a></h2><h3>Hard</h3><hr><p>Alice and Bob have an undirected graph of <code>n</code> nodes and three types of edges:</p>
