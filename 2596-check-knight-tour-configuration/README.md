<h2><a href="https://leetcode.com/problems/check-knight-tour-configuration/?envType=problem-list-v2&envId=wmjkndj5">2596. Check Knight Tour Configuration</a></h2><h3>Medium</h3><hr><p>There is a knight on an <code>n x n</code> chessboard. In a valid configuration, the knight starts <strong>at the top-left cell</strong> of the board and visits every cell on the board <strong>exactly once</strong>.</p>
