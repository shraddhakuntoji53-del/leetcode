<h2><a href="https://leetcode.com/problems/count-the-number-of-inversions/?envType=problem-list-v2&envId=wmjkndj5">3193. Count the Number of Inversions</a></h2><h3>Hard</h3><hr><p>You are given an integer <code>n</code> and a 2D array <code>requirements</code>, where <code>requirements[i] = [end<sub>i</sub>, cnt<sub>i</sub>]</code> represents the end index and the <strong>inversion</strong> count of each requirement.</p>
